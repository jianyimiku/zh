...
urlpatterns = [
    path('', views.UnansweredQuetionListView.as_view(), name='unanswered_q'),
    path('answered/', views.AnsweredQuetionListView.as_view(), name='answered_q'),
    ...
    path('ask-question-detail/<int:pk>/', views.QuestionDetailView.as_view(), name='question_detail'),
